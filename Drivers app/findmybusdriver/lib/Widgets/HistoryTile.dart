        ...
        children: <Widget>[
          ...
          Column(
            ...
            children: <Widget>[
              ...
              Container(
                child: Row(
                  children: <Widget>[
                    ...
                    Text('\$${history.fares}', style: TextStyle(fontFamily: 'Brand-Bold', fontSize: 16, color: Colors.black38),),
                  ],
                ),
              ),
              ...
              Text(HelperMethods.formatMyDate(history.createdAt), style: TextStyle(color: Colors.black38),),
            ],
          ),
