...
import 'package:find_my_bus/Widgets/PredictionTile.dart';
...
import 'package:find_my_bus/helpers/requesthelper.dart';
...
class _SearchPageState extends State<SearchPage> {
  ...
  void searchPlace(String placeName) async{
    ...
    if(placeName.length>1){
      String url = 'https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$placeName&key=$mapKey&sessiontoken=123254251&components=country:lk';
            ...
            child: Padding(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      Image.asset('images/posimarker.png', height: 20, width: 20,),
                  ...
                  Row(
                    children: <Widget>[
                      Image.asset('images/dest Icon.png', height: 20, width: 20,),
