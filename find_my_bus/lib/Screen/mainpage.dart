import 'package:find_my_bus/Screen/searchpage.dart';
import 'package:find_my_bus/Styles/styles.dart';
import 'package:find_my_bus/Widgets/BranchDivider.dart';
import 'package:find_my_bus/Widgets/CollectPaymentDialog.dart';
import 'package:find_my_bus/Widgets/NoBusDialog.dart';
import 'package:find_my_bus/Widgets/ProgressDialog.dart';
import 'package:find_my_bus/Widgets/fmbButton.dart';
import 'package:find_my_bus/datamodels/directiondetails.dart';
import 'package:find_my_bus/datamodels/nearbydriver.dart';
import 'package:find_my_bus/dataprovider/appdata.dart';
import 'package:find_my_bus/globalvariable.dart';
import 'package:find_my_bus/helpers/firehelper.dart';
import 'package:find_my_bus/helpers/helpermethods.dart';
import 'package:find_my_bus/rideVariables.dart';
...
class _MainPageState extends State<MainPage> with TickerProviderStateMixin {
  ...
  void setupPositionLocator() async {
    Position myPosition = await geoLocator.getCurrentPosition(desiredAccuracy: LocationAccuracy.bestForNavigation);
    ...
    // confirm location
    await HelperMethods.findCordinateAddress(myPosition, context);
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Column(
                          ...
                          children: <Widget>[
                            Text('Gishan', style: TextStyle(fontSize: 20, fontFamily: 'Brand-Bold'),),
                            SizedBox(height: 5,),
                            Text('View Profile'),
                          ],
                        )
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: <Widget>[
                                    Text('Bus', style: TextStyle(fontSize: 18, fontFamily: 'Brand-Bold'),),
                                    Text((tripDirectionDetails != null) ? tripDirectionDetails.distanceText : '', style: TextStyle(fontSize: 16, color: Colors.black45),)
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Icon(FontAwesomeIcons.moneyBillAlt, size: 18, color: Colors.blue,),
                              SizedBox(width: 16,),
                              Text('Cash'),
                              SizedBox(width: 5,),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Text(driverCarDetails, style: TextStyle(color: Colors.black38),),
